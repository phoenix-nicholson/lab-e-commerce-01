...
test('Render Luffy Html snippet', (expect) => {
    const expected = `<div class="pirate-card"><h2>Monkey D. Luffy</h2><img src="./assets/luffy-2.jpeg"><button id="luffy-pirate" class="add-button">Add to list!</button><h3>Straw Hat Pirates</h3><p>1.5B Berries</p><p2>Captain</p2></div>`;
...
test('Render Zoro Html snippet', (expect) => {
    const expected = `<div class="pirate-card"><h2>Roronoa Zoro</h2><img src="./assets/zoro.jpeg"><button id="zoro-pirate" class="add-button">Add to list!</button><h3>Straw Hat Pirates</h3><p>320M Berries</p><p2>Vice Captain</p2></div>`;
...
test('Render Chopper HTMl snippet', (expect)=> {
    const expected = `<div class="pirate-card"><h2>Tony-Tony Chopper</h2><img src="./assets/chopper.jpeg"><button id="chopper-pirate" class="add-button">Add to list!</button><h3>Straw Hat Pirates</h3><p>100 Berries</p><p2>Doctor</p2></div>`;
...
test('Render Law HTML snippet', (expect)=>{
    const expected = `<div class="pirate-card"><h2>Trafalgar D. Water Law</h2><img src="./assets/law.jpeg"><button id="law-pirate" class="add-button">Add to list!</button><h3>Heart Pirates</h3><p>500M Berries</p><p2>Captain</p2></div>`;
...
test('Render Shanks HTML snippet', (expect)=>{
    const expected = `<div class="pirate-card"><h2>Red Haired Shanks</h2><img src="./assets/shanks.jpeg"><button id="shanks-pirate" class="add-button">Add to list!</button><h3>Red Hair Pirates</h3><p>4.05B Berries</p><p2>Captain</p2></div>`;
...
test('Render Robin HTML snippet', (expect)=>{
    const expected = `<div class="pirate-card"><h2>Nico Robin</h2><img src="./assets/robin.png"><button id="robin-pirate" class="add-button">Add to list!</button><h3>Straw Hat Pirates</h3><p>130M Berries</p><p2>Archaeologist</p2></div>`;
